...
#define USBClearUSBInterrupt() IFS5bits.USB1IF = 0;
    ...
    #define USBMaskInterrupts(flags) {flags = IEC5bits.USB1IE; IEC5bits.USB1IE = 0;}
    #define USBUnmaskInterrupts(flags) {IEC5bits.USB1IE = flags;}
#else
    #define USBMaskInterrupts(flags) 
    #define USBUnmaskInterrupts(flags) 
#endif
